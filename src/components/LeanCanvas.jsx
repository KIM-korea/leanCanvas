  ...
  return (
    <div className="border-4 border-black">
      <div className="grid grid-cols-5">
        ...
        />
        <CanvasCard title={'8. 핵심지표'} onNotesChange={(notes) => handleNotesChange('keyMetrics', notes)} notes={canvas.keyMetrics?.notes} />
        <CanvasCard
          title={'상위개념'}
          isSubtitle
        ...
        />
        <CanvasCard title={'9. 고객 경로'} onNotesChange={(notes) => handleNotesChange('channels', notes)} notes={canvas.channels.notes} />
        <CanvasCard
          title={'얼리 어답터'}
          isSubtitle
